...
<div id="wrapper">
     <!-- Navigation -->
	   ...
	   <div class="xs">
  	 <h3>自我审核</h3>
  	 <form action="<%=Const.ROOT%>students/mycheck" method="post">
                <div class="input-group">
                   <textarea class="span8" name="myself" id="myself" cols="58" rows="10"></textarea>	                                         
                        <button class="btn btn-success" style="position:relative;left: 30px"" type="submit">提交</button>                  
