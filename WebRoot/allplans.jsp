...
<div id="wrapper">
     ...
     新增计划</button>
  			 ...
  			 <form action="<%=Const.ROOT%>user/allji" method="post">
					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								...
								<h2 class="modal-title">新增计划</h2>
							</div>
							<div class="modal-body">
								<form class="form-horizontal" method="post" action="<%=Const.ROOT%>user/addplans" >
									
								
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label" style="width: 130px">专业：</label>
									<div class="col-sm-8">
								...
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label" style="width: 130px">课程：</label>
									<div class="col-sm-8">
										<select   name="csid" required>
										
										<option value="-1" selected="selected">请选择</option>	
										<c:forEach items="${clist}" var="item1" varStatus="st">									
										<option value="${item1.id}">${item1.cname}</option>
										</c:forEach>											
										</select>
									</div>
