   ...
   <table class="table table-bordered">
        <thead>
          <tr>
            ...
            <th style="vertical-align:middle;text-align: center;">学院名称</th>
          </tr>
        </thead>
        <tbody>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								...
								<h2 class="modal-title">新增学院</h2>
							</div>
							<div class="modal-body">
								<form class="form-horizontal" method="post" action="<%=Const.ROOT%>user/addcollege" >
									
								
													
								
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label" style="width: 130px">学院名称：</label>
									<div class="col-sm-8">
											<input type="test" name="coname" class="form-control1"  ">
									</div>
