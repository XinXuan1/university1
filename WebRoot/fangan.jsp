...
<div id="wrapper">
     <!-- Navigation -->
  	 ...
  	 <form action="<%=Const.ROOT%>students/studyIdea" method="post">
   ...
   <table class="table table-bordered">
        <thead>
          <tr>
            ...
            <th style="vertical-align:middle;text-align: center;">总学分</th>
          </tr>
        </thead>
        <tbody>
		 <c:forEach items="${plist}" var="item" varStatus="st">
          <tr>
            ...
            <td  style="vertical-align:middle;text-align: center;">${item.sumxue}</td>  
          </tr>
   		</c:forEach>
        </tbody>
      </table>
