   ...
   <table class="table table-bordered">
        <thead>
          <tr>
            ...
            <th style="vertical-align:middle;text-align: center;">学院</th>
            <th style="vertical-align:middle;text-align: center;">教师个数</th>
          </tr>
        </thead>
        <tbody>
        <c:forEach items="${tlist}" var="item" varStatus="st">
          <tr>
            <th scope="row" style="vertical-align:middle;text-align: center;">${st.count}</th>
            <td  style="vertical-align:middle;text-align: center;">${item.coname}</td>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">
								<form class="form-horizontal" method="post" action="<%=Const.ROOT%>user/addteacher" >
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="test" name="tname" class="form-control1"  ">
									</div>
									
								</div>
								
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label" style="width: 130px">所在专业：</label>
									<div class="col-sm-8">
										<select   name="dsid" required>
								...
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label" style="width: 130px">教师类型：</label>
									<div class="col-sm-8">
										<select   name="tetype" required>
										
										<option value="-1" selected="selected">请选择</option>	
																	
										<option value="班主任">班主任</option>
										<option value="任课">任课</option>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="test" name="tmail" class="form-control1"  ">
									</div>
