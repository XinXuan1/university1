   ...
   <table class="table table-bordered">
        <thead>
          <tr>
            ...
            <th style="vertical-align:middle;text-align: center;">专业名称</th>
            <th style="vertical-align:middle;text-align: center;">所属学院</th>
          </tr>
        </thead>
        <tbody>
        <c:forEach items="${dlist}" var="item" varStatus="st">
          <tr>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								...
								<h2 class="modal-title">新增专业</h2>
							</div>
							<div class="modal-body">
								<form class="form-horizontal" method="post" action="<%=Const.ROOT%>user/adddepartment" >
									
								
													
								
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label" style="width: 130px">专业名称：</label>
									<div class="col-sm-8">
											<input type="test" name="dname" class="form-control1"  ">
									</div>
									
								</div>
								
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label" style="width: 130px">所属学院：</label>
									<div class="col-sm-8">
											<select   name="coid" required>
										
										<option value="-1" selected="selected">请选择</option>	
										<c:forEach items="${clist}" var="item1" varStatus="st">									
										<option value="${item1.id}">${item1.coname}</option>
										</c:forEach>											
										</select>
									</div>
